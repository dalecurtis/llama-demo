...
llama.drawGraph = function(container, format, isGapless, peaks) {
  ...
  waveformContainer.parentElement.querySelector('.play-overlay').onclick =
      function(e) {
...
document.addEventListener('DOMContentLoaded', function(event) {
  llama.drawGraph('waveform_adts_gapless', 'audio/aac', true, no_peaks);
  llama.drawGraph('waveform_adts_gap', 'audio/aac', false, no_peaks);
});
